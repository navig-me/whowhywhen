...
class APILog(SQLModel, table=True):
    ...
    is_mobile: Optional[bool] = Field(default=False)
    is_tablet: Optional[bool] = Field(default=False)
    is_pc: Optional[bool] = Field(default=False)
    is_touch_capable: Optional[bool] = Field(default=False)
